...
-   そんな時，目標を期中に調整（下方修正）することで，インセンティブ効果を維持することができる[@saly1994; @acharya2000]
    -   このような実務は一般的 [e.g., @libby2010]
-   しかし，先行研究では，期中の目標調整にして異なった見解が示されてきた。

::: columns
::: {.column width="50%"}
-   上記の通り，インセンティブ効果を維持し，業績を改善するという研究 [@liu2013; @kelly2015]
:::
...
::: {.column width="70%"}
![記述統計量](images/t1a.png){fig-align="right"}
:::
:::
...
$$
\begin{split}
\ln(Part-time \: work)_{ip} =& \beta_1Sales \: below \: target_{ip} + \beta_2(Sales  \:below \: target_{ip} × Switch_p) \\ 
